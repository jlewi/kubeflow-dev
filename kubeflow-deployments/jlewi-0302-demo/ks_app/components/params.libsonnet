{
  ...
  components: {
    ...
    pipeline: {
      minioPd: 'jlewi-0302-demo-storage-artifact-store',
      mysqlPd: 'jlewi-0302-demo-storage-metadata-store',
      name: 'pipeline',
    },
    katib: {
    ...
    "iap-ingress": {
      ...
      hostname: 'jlewi-0302-demo.endpoints.kubeflow-dev.cloud.goog',
      ingressSetupImage: 'gcr.io/kubeflow-images-public/ingress-setup:latest',
      ipName: 'jlewi-0302-demo-ip',
