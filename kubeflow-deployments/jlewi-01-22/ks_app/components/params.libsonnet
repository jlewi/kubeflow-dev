{
  ...
  components: {
    ...
    katib: {
      katibUIImage: 'gcr.io/kubeflow-images-public/katib/katib-ui:v0.1.2-alpha-113-ga24c428',
      metricsCollectorImage: 'gcr.io/kubeflow-images-public/katib/metrics-collector:v0.1.2-alpha-113-ga24c428',
      name: 'katib',
      studyJobControllerImage: 'gcr.io/kubeflow-images-public/katib/studyjob-controller:v0.1.2-alpha-113-ga24c428',
      suggestionBayesianOptimizationImage: 'gcr.io/kubeflow-images-public/katib/suggestion-bayesianoptimization:v0.1.2-alpha-113-ga24c428',
      suggestionGridImage: 'gcr.io/kubeflow-images-public/katib/suggestion-grid:v0.1.2-alpha-113-ga24c428',
      suggestionHyperbandImage: 'gcr.io/kubeflow-images-public/katib/suggestion-hyperband:v0.1.2-alpha-113-ga24c428',
      suggestionRandomImage: 'gcr.io/kubeflow-images-public/katib/suggestion-random:v0.1.2-alpha-113-ga24c428',
      vizierCoreImage: 'gcr.io/kubeflow-images-public/katib/vizier-core:v0.1.2-alpha-113-ga24c428',
      vizierCoreRestImage: 'gcr.io/kubeflow-images-public/katib/vizier-core-rest:v0.1.2-alpha-113-ga24c428',
    ...
    application: {
      components: ['ambassador', 'jupyter', 'centraldashboard', 'tf-job-operator', 'pytorch-operator', 'spartakus', 'argo', 'pipeline', 'katib', 'cloud-endpoints', 'cert-manager', 'iap-ingress'],
      extendedInfo: 'false',
      name: 'jlewi-01-22',
      type: 'kubeflow',
      version: '0.4',
    ...
    "iap-ingress": {
      ...
      hostname: 'jlewi-01-22.endpoints.cloud-ml-dev.cloud.goog',
      ingressSetupImage: 'gcr.io/kubeflow-images-public/ingress-setup:latest',
      ipName: 'jlewi-01-22-ip',
