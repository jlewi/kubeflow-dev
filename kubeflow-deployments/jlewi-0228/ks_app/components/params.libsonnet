{
  ...
  components: {
    ...
    pipeline: {
      minioPd: 'jlewi-0228-storage-artifact-store',
      mysqlPd: 'jlewi-0228-storage-metadata-store',
      name: 'pipeline',
    },
    katib: {
    ...
    "iap-ingress": {
      ...
      hostname: 'jlewi-0228.endpoints.cloud-ml-dev.cloud.goog',
      ingressSetupImage: 'gcr.io/kubeflow-images-public/ingress-setup:latest',
      ipName: 'jlewi-0228-ip',
