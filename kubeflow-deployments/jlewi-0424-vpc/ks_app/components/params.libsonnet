{
  ...
  components: {
    ...
    metacontroller: {
      image: 'gcr.io/kubeflow-dev/metacontroller:v0.3.0',
      name: 'metacontroller',
    },
    ambassador: {
      ambassadorImage: 'gcr.io/kubeflow-dev/datawire/ambassador:0.37.0',
    ...
    argo: {
      ...
      executorImage: 'gcr.io/kubeflow-dev/argoexec:v2.2.0',
      injectIstio: false,
      name: 'argo',
      uiImage: 'gcr.io/kubeflow-dev/argoui:v2.2.0',
      workflowControllerImage: 'gcr.io/kubeflow-dev/workflow-controller:v2.2.0',
    },
    centraldashboard: {
    ...
    "cloud-endpoints": {
      cloudEndpointsImage: 'gcr.io/kubeflow-dev/cloud-solutions-group/cloud-endpoints-controller:0.2.1',
    ...
    katib: {
      ...
      vizierDbImage: 'gcr.io/kubeflow-dev/mysql:8.0.3',
    },
    "notebook-controller": {
    ...
    pipeline: {
      apiImage: 'gcr.io/kubeflow-dev/ml-pipeline/api-server:0.1.17',
      injectIstio: false,
      minioImage: 'gcr.io/kubeflow-dev/minio:RELEASE.2018-02-09T22-40-05Z',
      minioPd: 'jlewi-0424-vpc-storage-artifact-store',
      mysqlImage: 'gcr.io/kubeflow-dev/mysql:8.0.3',
      mysqlPd: 'jlewi-0424-vpc-storage-metadata-store',
      name: 'pipeline',
      persistenceAgentImage: 'gcr.io/kubeflow-dev/ml-pipeline/persistenceagent:0.1.17',
      scheduledWorkflowImage: 'gcr.io/kubeflow-dev/ml-pipeline/scheduledworkflow:0.1.17',
      viewerCrdControllerImage: 'gcr.io/kubeflow-dev/ml-pipeline/viewer-crd-controller:0.1.17',
    },
    "pytorch-operator": {
      cloud: 'null',
